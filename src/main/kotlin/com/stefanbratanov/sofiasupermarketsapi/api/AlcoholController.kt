...
//          if (filteredAndDistinctProducts != null) {
//              if (it != null) {
...
//        }
//      }
//    return categorizedProducts?.let { productStore.copy(products = it) }
//  }
//
...
//
//    return filteredProducts?.let { productStore.copy(products = it) }
//  }
//
...
//        }
//      }
//    return productsWithPics?.let { productStore.copy(products = it) }
//  }
//
